...
var playstles = ["Koala", "Reindeer", "PlayStation® 3™", "Cyclist", "Guy outside your window", "Madeline from Celeste", "Guy from dinner tonight"]
